...
class sd_RscCombo {
	...
	class ComboScrollBar : sd_RscScrollBar {};
};
...
class sd_RscButtonMenu : sd_RscShortcutButton {
	idc = -1;
	type = 16;
	style = "0x02 + 0xC0";
	default = 0;
...
class sd_RscListBox
{
	...
	tooltipColorBox[] = {1,1,1,1};
	tooltipColorShade[] = {0,0,0,0.65};
	class ListScrollBar: sd_RscScrollBar
	{
		color[] = {1,1,1,1};
		autoScrollEnabled = 1;
	};
...
class sd_RscControlsGroupNoScrollbars : sd_RscControlsGroup {
