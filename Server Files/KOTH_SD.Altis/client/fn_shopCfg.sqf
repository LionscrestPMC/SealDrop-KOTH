			...
			default
			{
				["Ammunition",
					[
						...
						["100Rnd_65x39_caseless_mag",nil,4],
						["20Rnd_556x45_UW_mag",nil,3],
						["20Rnd_762x51_Mag",nil,12],
						["30Rnd_556x45_Stanag",nil,13],
						["30Rnd_556x45_Stanag_Tracer_Red",nil,13],
						["30Rnd_556x45_Stanag_Tracer_Green",nil,13],
						["30Rnd_556x45_Stanag_Tracer_Yellow",nil,13],
						...
						["30Rnd_45ACP_Mag_SMG_01_tracer_green",nil,5],
