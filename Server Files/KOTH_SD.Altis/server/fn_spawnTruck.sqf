...
if(isServer) then {	
	...
	{
		spawntruck_blu = "O_Truck_03_medical_F" createVehicle (getMarkerPos "respawn_vehicle_west");
		spawntruck_blu setPos (getMarkerPos "respawn_vehicle_west");
	...
	{
		spawntruck_red = "O_Truck_03_medical_F" createVehicle (getMarkerPos "respawn_vehicle_east");
	...
	if(_side isEqualTo "red") then
	{
		...
		uiSleep 300;
		spawntruck_red = "O_Truck_03_medical_F" createVehicle (getMarkerPos "respawn_vehicle_east");
		spawntruck_red setPos (getMarkerPos "respawn_vehicle_east");
		spawntruck_red lock 1;
		spawntruck_red engineOn true;
		clearItemCargoGlobal spawntruck_red;
		spawntruck_red setDir (markerDir "respawn_vehicle_east");
	...
	{
		spawntruck_ind = "O_Truck_03_medical_F" createVehicle (getMarkerPos "respawn_vehicle_indep");
		spawntruck_ind setPos (getMarkerPos "respawn_vehicle_indep");
		spawntruck_ind lock 1;
		spawntruck_ind engineOn true;
		clearItemCargoGlobal spawntruck_ind;
		spawntruck_ind setDir (markerDir "respawn_vehicle_indep");
